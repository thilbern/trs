...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% SOURCE : http://www.princeton.edu/~kung/ele571/571-MatLab/571BP_Chad/kmeans.m   %%
%%                                                                                 %%
%% To avoid conflict the name of the function has been renamed: kmeans => kmeans15 %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [idx, C, sumD, D] = kmeans15(X, k, varargin)
